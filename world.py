...
class StartTile(MapTile):
	description = """You find yourself in a deserted college campus with restricted pathways all over the place, and look up to see a violet sky.
...
class NearVictory(MapTile):
	description = """You can see a the real world at the end of this corridor. Could that be your way out from this terrifying college campus?"""


class VictoryTile(MapTile):
	description = """You see a bright light in the distance...
		It grows as you get closer! It's THE REAL WORLD!
		Victory is yours!
		"""
