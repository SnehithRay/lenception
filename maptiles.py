...
class StartTile(MapTile):
	description = """You wake up in a strange labaratory looking cell, wearing a labcoat
		"""


class FightTile(MapTile):
	description = """You encounter a foe. You must fight him."""


class ExitTile(MapTile):
	description = """You find a door that leads to an exit hallway."""
